...
public class ArrayLab {
    public static void main(String[] args) {
        ...
        System.out.println("'A'로 시작하는 이름들");
        for (int i = 0; i < 5; i++) {
            if (arr2[i].charAt(0) == 'A') {
        ...
        for (int i = 0; i < 2; i++) {
            System.out.print("[ ");
            for (int j = 0; j < 3; j++) {
                System.out.print(arr4[i][j] + arr5[i][j] + " ");
            }
            System.out.print("]");
            System.out.println();
        }
        ...
        Arrays.sort(arr6);
        System.out.println("최댓값: " + arr6[arr6.length - 1]);
        System.out.println("최솟값: " + arr6[0]);
        System.out.println("중앙값: " + arr6[4]);
